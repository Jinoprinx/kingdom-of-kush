...
export default function CitizenshipPage() {
  return (
    <div className="bg-[#F9F9F7] text-[#1A1A1A] min-h-screen">
      {/* Hero */}
      <section className="relative pt-28 pb-20 lg:pt-32 lg:pb-32 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <div className="absolute top-0 right-0 w-3/4 h-3/4 bg-[#D80000] rounded-full opacity-[0.05] blur-[120px] animate-pulse"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-[#1A1A1A] font-playfair mb-6">
      ...
      {/* Eligibility */}
      <section className="py-16 lg:py-24 border-y border-[#C5A059]/10 relative overflow-hidden bg-white">
        {/* Background Image via Tailwind - reduced opacity or light overlay */}
        <div
          className="absolute inset-0 bg-[url('/images/kush1.jpg')] bg-cover bg-center opacity-5 z-0"
          aria-hidden="true"
        ></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-[#1A1A1A] font-playfair">
              Who Qualifies?
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={i}
                className="p-6 rounded-2xl bg-white/60 backdrop-blur-sm border border-gray-100 hover:border-[#C5A059]/30 transition-colors relative z-30 shadow-sm"
              >
      ...
      {/* Pathway Steps */}
      <section className="py-16 lg:py-24 bg-gradient-to-b from-[#F9F9F7] to-[#F1F1EF]">
      ...
      {/* Benefits */}
      <section className="py-16 lg:py-24 border-y border-[#C5A059]/10 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl lg:text-4xl font-bold text-[#1A1A1A] font-playfair mb-6">
            ...
            <div className="relative">
              <div className="aspect-[4/5] rounded-2xl overflow-hidden border border-[#C5A059]/10 shadow-xl">
                <img
      ...
      {/* FAQ */}
      <section className="py-16 lg:py-24 bg-[#F9F9F7]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <p className="text-sm font-medium text-[#D80000] mb-3 tracking-wider uppercase">(Common Questions)</p>
            <h2 className="text-3xl font-bold text-[#1A1A1A] font-playfair">You Asked</h2>
          </div>
          <div className="space-y-6">
            {[
              ...
              <div key={i} className="border border-gray-200 rounded-2xl p-6 bg-white shadow-sm hover:shadow-md transition-shadow">
                <h3 className="font-bold text-[#1A1A1A] text-lg mb-2">{faq.q}</h3>
      ...
      <section className="relative py-24 lg:py-32 bg-[#D80000] overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <Link
            ...
            className="inline-flex items-center gap-3 bg-white text-[#C5A059] px-8 py-4 rounded-full font-semibold hover:bg-gray-100 transition-colors group shadow-xl"
          >
