        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <Link
                href="/citizenship"
                className="inline-flex items-center gap-2 text-[#C5A059] hover:text-[#b08b49] font-medium group"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div
                key={i}
                className="p-6 rounded-2xl bg-white border border-gray-100 hover:border-[#C5A059]/30 transition-colors shadow-sm"
              >
      ...
      <section className="relative py-24 lg:py-32 bg-[#D80000] overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link
              href="/citizenship"
              className="bg-white text-[#C5A059] px-8 py-4 rounded-full font-semibold hover:bg-gray-100 transition-colors shadow-lg"
            >
